  ...
  return (
    <div className="terms-modal-overlay" onClick={handleOverlayClick}>
      <div className="terms-modal-content">
        ...
        <h2>Attendee Terms of Use</h2>
        <p><strong>Last Updated: 29/06/2025</strong></p>

        <h3>1. Introduction</h3>
        <p>Welcome to Prizmatix Ltd ("Prizmatix," "we," "us," or "our")...</p>

        <h3>2. Nature of Our Platform</h3>
        <p>Prizmatix provides a platform that connects event organisers ("Hosts") with attendees...</p>
        ...
        <p>The Host may change the date, time, venue, or content of the event...</p>
        ...
        <p>We may suspend or terminate your access for breach of terms.</p>

        <h3>14. Dispute Resolution</h3>
        <p>Contact: <a href="mailto:support@prizmatix.nz" className="themed-link">support@prizmatix.nz</a>. Legal matters governed by NZ law, courts of Wellington.</p>

        <h3>15. Changes to Terms</h3>
        <p>Terms may be updated at any time. Continued use = acceptance.</p>
